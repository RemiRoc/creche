...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    phone_number = models.CharField(_('phone_number'), max_length=16, blank=True, default="")
    ...
    is_active = models.BooleanField(_('activity status'), default=True)
    ...
    def get_running_instance(self):
        return len(Instance.objects.filter(user=self, status = 1))

    @classmethod 
    def get_user_from_id(self,id):
        return User.objects.filter(pk=id)[0] 
